...
class ProductView(View):
 def get(self,request):
    ...
    return render(request,'app/home.html',{'bottomwears':bottomwears,
        'topwears':topwears, 'mobile':mobile,'totalitem':totalitem})
...
def payment_done(request):
  ...
  try:
      ...
      return HttpResponse("Please add your profile")
  customer = Customer.objects.get(id=custid)
  cart = Cart.objects.filter(user=user)
  for c in cart:
...
def mobile(request, data=None):
    ...
    elif data == 'x3' or 'M10' or 'Realme' or 'Samsung' or 'Redmi' or 'I Phone' or 'Pocco':
...
class ProfileView(View):
    ...
    #     Product.objects.get('title'==search)
